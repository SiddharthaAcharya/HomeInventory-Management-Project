...
public class HomeInventory extends JFrame 
{
	...
	JButton newButton =new JButton(new ImageIcon("add-file.png"));
	JButton deleteButton=new JButton(new ImageIcon("delete.png"));
	JButton saveButton=new JButton(new ImageIcon("floppy.png"));
	JButton previousButton=new JButton(new ImageIcon("left-arrow.png"));
	JButton nextButton=new JButton(new ImageIcon("right-arrow.png"));
	JButton printButton=new JButton(new ImageIcon("printer.png"));
    ...
    public HomeInventory()
    {
    	...
    	getContentPane().add(itemLabel,gridBagConstraints);
    	...
    	gridBagConstraints.insets = new Insets(10, 10, 0, 10);
    	gridBagConstraints.anchor = GridBagConstraints.EAST;
    	getContentPane().add(serialLabel, gridBagConstraints);
    	...
    	gridBagConstraints.insets = new Insets(10, 10, 0, 10);
    	gridBagConstraints.anchor = GridBagConstraints.EAST;
    	getContentPane().add(storeLabel, gridBagConstraints);
    	...
    	gridBagConstraints.insets = new Insets(10, 10, 0, 10);
    	gridBagConstraints.anchor = GridBagConstraints.EAST;
    	getContentPane().add(photoLabel, gridBagConstraints);
    	...
    	{ 
    		...
    		searchPanel.add(searchButton[i], gridBagConstraints);
    		// add method 
    	...
    	gridBagConstraints.anchor = GridBagConstraints.CENTER;
    	getContentPane().add(photoPanel, gridBagConstraints);
   ...
   /* private void exitForm(WindowEvent evt) 
    ...
    private void photoButtonActiobPerformed(ActionEvent e)
    {
    	exitForm(null);
    }
